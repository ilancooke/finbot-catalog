...
writes compact catalog outputs for future dashboard, feature, and modeling packages.
...
- Default data root resolution should remain: `FINBOT_DATA_ROOT`, then `./data`.
